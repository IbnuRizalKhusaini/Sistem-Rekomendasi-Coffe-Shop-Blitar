                                ...
                                <div class="col">
                                    <form action="{{ route('user.weight.update', $criteria->id) }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="criteria_name" id="criteria_name" class="form-control" value="{{ $criteria->criteria_name }}" disabled>
                                        </div>

                                        <div class="mb-3">
                                            <label for="weight" class="form-label">Bobot</label>
                                            <input type="number" name="weight" id="weight" class="form-control" value="{{ $weightValue->weight }}">
                                        </div>
