...
class WeightValueController extends Controller
{
    public function index()
    {
        ...
        return view('users.pages.input-weight.index', compact('criterias', 'weightValue', 'alternatives'));
    }
    ...
    public function edit($criteria_id)
    {
        ...
        return view('users.pages.input-weight.edit', compact('criteria', 'weightValue'));
    }
